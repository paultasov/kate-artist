...
const demoArtworks: Artwork[] = [
  {
    ...
    price: 19500,
    category: 'Хаос',
    imageUrl: publicUrl('/artworks/artwork-temp-02.png'),
  ...
  },
  {
    ...
    price: 22000,
    category: 'Пейзаж',
    imageUrl: publicUrl('/artworks/artwork-temp-03.png'),
    orientation: 'vertical',
    featured: false,
  ...
  },
  {
    ...
    price: 15800,
    category: 'Портрет',
    imageUrl: publicUrl('/artworks/artwork-temp-04.png'),
    orientation: 'vertical',
    featured: true,
  ...
  },
  {
    ...
    price: 24000,
    category: 'Портрет',
    imageUrl: publicUrl('/artworks/artwork-temp-05.png'),
    orientation: 'vertical',
    featured: false,
  ...
  },
  {
    ...
    price: 17200,
    category: 'Портрет',
    imageUrl: publicUrl('/artworks/artwork-temp-06.png'),
    orientation: 'vertical',
    featured: true,
  ...
  },
  {
    ...
    price: 20500,
    category: 'Хаос',
    imageUrl: publicUrl('/artworks/artwork-temp-07.png'),
    orientation: 'vertical',
    featured: false,
  ...
  },
  {
    ...
    price: 18600,
    category: 'Пейзаж',
    imageUrl: publicUrl('/artworks/artwork-temp-08.png'),
  ...
  },
  {
    ...
    price: 21000,
    category: 'Пейзаж',
    imageUrl: publicUrl('/artworks/artwork-temp-09.png'),
    orientation: 'horizontal',
    featured: false,
